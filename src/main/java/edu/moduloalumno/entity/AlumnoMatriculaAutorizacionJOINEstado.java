...
public class AlumnoMatriculaAutorizacionJOINEstado{
    ...
    public AlumnoMatriculaAutorizacionJOINEstado() {
        super();
    }

    public AlumnoMatriculaAutorizacionJOINEstado(Integer id_autorizacion, String cod_alumno, Integer id_programa, String semestre,
                                                String n_autorizacion, Integer anio_autorizacion, Date fecha_emision, String usuario_emision,
                                                float importe, float penalidad, float amortizacion, float saldo, Date fecha_vencimieto, Integer id_rec,
                                                String autorizacion_estado, Integer id_autorizacion_estado, String desc_autorizacion_estado)
    {
        super();
	...
	public int hashCode() {
		...
		result = prime * result + id_autorizacion_estado;
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AlumnoMatriculaAutorizacionJOINEstado other = (AlumnoMatriculaAutorizacionJOINEstado) obj;
		if (id_autorizacion == null) {
			if (other.id_autorizacion != null)
				return false;
		} else if (!id_autorizacion.equals(other.id_autorizacion))
			return false;
		if ( id_autorizacion_estado!= other.id_autorizacion_estado)
			return false;
		return true;
	}
